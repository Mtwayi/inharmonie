...
<div class="wrap">
    ...
    <div class="facetwp-region facetwp-region-welcome about-wrap">
        <h1><?php _e( 'Welcome to FacetWP', 'fwp' ); ?></h1>
        ...
        <div class="welcome-box-wrap">
            ...
            <div class="welcome-box">
                ...
                <p>In order for facets to appear, FacetWP needs to know <strong>which posts to filter upon</strong>, as well as <strong>how the posts should appear</strong>. There are two methods for setting up templates in FacetWP.</p>
                <p><strong>1. Add a CSS class to your theme file</strong></p>
                ...
                <p><strong>2. Create a FacetWP template</strong></p>
                <p>Click the "Add new" button to create your own custom template. This method generates a shortcode, which can be pasted into the WYSIWYG editor, a text widget, or into a theme file (see the <code>facetwp_display</code> function).</p>
